import { insertCommnet, insertPost, selectCommentsByAuthor, selectPost, selectPostsByAuthor, selectRandomPost, selectUser, updateUser } from "../db/queries"
...
const rpcImpl: PromiseRpc = {
    ...
    createComment: async (req) => {
        await insertCommnet(req.body, userId, req.postId)
        return {}
    },
    readPost: async (req) => {
